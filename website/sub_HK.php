	...
	<!-- Header -->
		<div id="header">
			<div class="container">
				...
				<!-- Logo -->
					<div id="logo">
						<h1><a href="#">Hong Kong</a></h1>
						<span><font color="gray" size="5pt" style="font-family:Microsoft JhengHei;">香港</font></span>
					</div>
						...
						<div id="sidebar" class="4u">
							<section>
								...
								<div>
									...
									<img src="../image/HKD.png" height="70%" width="70%">
								</div>
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								...
								<div>
									...
									<iframe width="800px" height="500px" src="../graph/sub_HK.php"></iframe>
								</div>
								...
								<div>
									...
									<iframe width="100%" height="360px" src="../calculator/change_HKD.php"></iframe>
								</div>
