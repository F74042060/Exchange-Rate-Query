	...
	<!-- Header -->
		<div id="header">
			<div class="container">
				...
				<!-- Logo -->
					<div id="logo">
						<h1><a href="#">Thailand</a></h1>
						<span><font color="gray" size="5pt" style="font-family:Microsoft JhengHei;">泰國</font></span>
					</div>
						...
						<div id="sidebar" class="4u">
							<section>
								...
								<div>
									...
									<img src="../image/THB.png" height="70%" width="70%">
								</div>
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								...
								<div>
									...
									<iframe width="800px" height="500px" src="../graph/sub_TH.php"></iframe>
								</div>
								...
								<div>
									...
									<iframe width="100%" height="360px" src="../calculator/change_THB.php"></iframe>
								</div>
