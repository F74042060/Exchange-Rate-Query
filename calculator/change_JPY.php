...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_JPY.php">
		...
		<input type="radio" name="from" value="JPY"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">JPY</font></label>
		...
		<input type="radio" name="to" value="JPY" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">JPY</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>JPY: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "JPY"){	//from JPY to JPY
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>JPY: ". $money. "<br> ";
	}
}
