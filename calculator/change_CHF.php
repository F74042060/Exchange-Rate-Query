...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_CHF.php">
		...
		<input type="radio" name="from" value="CHF"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">CHF</font></label>
		...
		<input type="radio" name="to" value="CHF" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">CHF</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>CHF: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "CHF"){	//from CHF to CHF
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>CHF: ". $money. "<br> ";
	}
}
