...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_CNY.php">
		...
		<input type="radio" name="from" value="CNY"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">CNY</font></label>
		...
		<input type="radio" name="to" value="CNY" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">CNY</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>CNY: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "CNY"){	//from CNY to CNY
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>CNY: ". $money. "<br> ";
	}
}
