...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_PHP.php">
		...
		<input type="radio" name="from" value="PHP"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">PHP</font></label>
		...
		<input type="radio" name="to" value="PHP" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">PHP</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>PHP: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "PHP"){	//from PHP to PHP
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>PHP: ". $money. "<br> ";
	}
}
