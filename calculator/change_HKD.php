...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_HKD.php">
		...
		<input type="radio" name="from" value="HKD"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">HKD</font></label>
		...
		<input type="radio" name="to" value="HKD" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">HKD</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>HKD: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "HKD"){	//from HKD to HKD
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>HKD: ". $money. "<br> ";
	}
}
