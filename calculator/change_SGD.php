...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_SGD.php">
		...
		<input type="radio" name="from" value="SGD"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">SGD</font></label>
		...
		<input type="radio" name="to" value="SGD" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">SGD</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>SGD: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "SGD"){	//from SGD to SGD
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>SGD: ". $money. "<br> ";
	}
}
