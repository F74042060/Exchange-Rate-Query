...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_NZD.php">
		...
		<input type="radio" name="from" value="NZD"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">NZD</font></label>
		...
		<input type="radio" name="to" value="NZD" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">NZD</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>NZD: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "NZD"){	//from NZD to NZD
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>NZD: ". $money. "<br> ";
	}
}
