...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_VND.php">
		...
		<input type="radio" name="from" value="VND"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">VND</font></label>
		...
		<input type="radio" name="to" value="VND" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">VND</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>VND: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "VND"){	//from VND to VND
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>VND: ". $money. "<br> ";
	}
}
