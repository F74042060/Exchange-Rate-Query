...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_CAD.php">
		...
		<input type="radio" name="from" value="CAD"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">CAD</font></label>
		...
		<input type="radio" name="to" value="CAD" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">CAD</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>CAD: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "CAD"){	//from CAD to CAD
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>CAD: ". $money. "<br> ";
	}
}
