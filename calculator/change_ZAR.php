...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_ZAR.php">
		...
		<input type="radio" name="from" value="ZAR"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">ZAR</font></label>
		...
		<input type="radio" name="to" value="ZAR" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">ZAR</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>ZAR: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "ZAR"){	//from ZAR to ZAR
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>ZAR: ". $money. "<br> ";
	}
}
