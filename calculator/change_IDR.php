...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_IDR.php">
		...
		<input type="radio" name="from" value="IDR"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">IDR</font></label>
		...
		<input type="radio" name="to" value="IDR" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">IDR</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>IDR: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "IDR"){	//from IDR to IDR
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>IDR: ". $money. "<br> ";
	}
}
