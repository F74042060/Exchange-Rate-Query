...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_MYR.php">
		...
		<input type="radio" name="from" value="MYR"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">MYR</font></label>
		...
		<input type="radio" name="to" value="MYR" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">MYR</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>MYR: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "MYR"){	//from MYR to MYR
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>MYR: ". $money. "<br> ";
	}
}
