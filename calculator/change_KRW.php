...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_KRW.php">
		...
		<input type="radio" name="from" value="KRW"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">KRW</font></label>
		...
		<input type="radio" name="to" value="KRW" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">KRW</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>KRW: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "KRW"){	//from KRW to KRW
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>KRW: ". $money. "<br> ";
	}
}
