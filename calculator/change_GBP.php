...
<body>
	...
	<form  id="form1" method="get" align="center" action="http://localhost/Project/calculator/change_GBP.php">
		...
		<input type="radio" name="from" value="GBP"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">GBP</font></label>
		...
		<input type="radio" name="to" value="GBP" checked="true"><label><font size="4pt" color="gray" style="font-family:Microsoft JhengHei;">GBP</font></label>		
...
if($from == "NT"){	
	...
	if($to == "NT"){	//from NT to NT
		...
		{	
			...
			if($row['Currency'] == $to){
				echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>GBP: ". $value . "<br> ";
			}
		}
	}
	//search whole table
	...
	}else if($to == "GBP"){	//from GBP to GBP
		echo "<center><h2><font color=gray size='5pt' style='font-family:Microsoft JhengHei;'>GBP: ". $money. "<br> ";
	}
}
